    ...
    <div class="container"> 
      <div class="row login-register-cover">
        <div class="col-lg-4 col-md-6 col-sm-12 mx-auto">
          ...
          <form class="login-register text-start mt-20" action="{{route('frontend.auth.register.employer.store')}}" method="post">
            @csrf @method('POST')
            <div class="form-group">
                <label class="form-label" for="input-1">Your Name *</label>
                <input class="form-control" id="input-1" type="text" required="" name="name" placeholder="Kaung Kaung" value="{{ old('name') }}">
                @error('name')
              ...
              <div class="form-group">
                ...
                <input class="form-control" id="input-2" type="email" required="" name="email" placeholder="kaungkaung@gmail.com" value="{{ old('email') }}">
                @error('email')
                  <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
                  </span>
              ...
              <div class="form-group">
                ...
                <input class="form-control" id="input-3" type="text" required="" name="company_name" placeholder="Kaung Co., Ltd" value="{{ old('company_name') }}">
                @error('company_name')
                  <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
                  </span>
