        ...
        <div class="col-lg-6 col-md-12">
            <form action="{{route('frontend.seeker.update')}}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <textarea  id="editor" class="form-control" rows="4" name="headline" >{{ $seeker->headline }}</textarea>
                </div>

                <div class="form-group">
                    <label class="font-sm color-text-muted mb-10">Professional Category</label>
                    @php 
                    ...
                    @foreach($categories as $category)
                        <option @if($category->id == $seeker->category_id) selected @endif value="{{$category->id}}">{{$category->name}}</option>
                    @endforeach
                    </select>
