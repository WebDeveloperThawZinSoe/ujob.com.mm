            ...
            <div class="row mt-10">
                ...
                <div class="col-lg-4 col-md-12 text-lg-end">
                    <a class="btn btn-preview-icon btn-apply btn-apply-big"
                        href="{{route('frontend.cv', auth()->user()->seeker->id)}}">Preview</a>
                </div>
            </div>
        </div>
            ...
            <div class="col-lg-3 col-md-4 col-sm-12">
                <div class="box-nav-tabs nav-tavs-profile mb-5">
                    <ul class="nav" role="tablist">
                        <li>
                            <a class="btn btn-border aboutus-icon mb-20 active" href="#tab-my-profile"
                                data-bs-toggle="tab" role="tab" aria-controls="tab-my-profile" aria-selected="true">My
                                Profile</a>
                        </li>
                        <li>
                            <a class="btn btn-border recruitment-icon mb-20" href="#tab-my-jobs" data-bs-toggle="tab"
                                role="tab" aria-controls="tab-my-jobs" aria-selected="false">My Jobs</a>
                        </li>
                        <li>
                            <a class="btn btn-border people-icon mb-20"
                                href="{{route('frontend.cv', auth()->user()->seeker->id)}}">View CV</a>
                        </li>
                    </ul>
                </div>
            </div>
                        ...
                        <div class="tab-pane fade show active" id="tab-my-profile" role="tabpanel"
                            ...
                            <div class="mt-35 mb-40 box-info-profie">
                                <div class="image-profile">
                                    <img src="{{ asset('assets/imgs/page/candidates/candidate-profile.png') }}"
                                        alt="jobbox">
                                </div>
                            ...
                            <div class="row form-contact">
                                <div class="col-lg-6 col-md-12">
                                    <form action="#" method="POST">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" rows="4"
                                                name="headline">{{ $seeker->headline }}</textarea>
                                        </div>
                                        <div class="form-group">
                                            <label class="font-sm color-text-muted mb-10">Summary</label>
                                            <textarea class="form-control" rows="4"
                                                name="summary">{{ $seeker->summary }}</textarea>
                                        </div>
                                    ...
                                    <form action="{{ route('frontend.account.changePassword', auth()->user()->id) }}"
                                        method="POST">
                                        @csrf
                                        <div class="row">
                                            <div class="col-lg-12">
                                ...
                                <div class="col-md-6 col-lg-6">
                                    ...
                                    <ul id="experienceList mb-15">
                                        ...
                                        <div class="card mb-10">
                                            <div class="card-body">
                                                ...
                                                <button type="button"
                                                    class="btn btn-secondary btn-sm editExperienceButton"
                                                ...
                                                <button type="button"
                                                    class="btn btn-danger btn-sm deleteExperienceButton"
                                                    data-id="{{ $data->id }}">
                                                    Delete
                                                </button>
                                            </div>
                                        ...
                                        <div class="card mb-10">
                                            <div class="card-body">
                                                ...
                                                <p>{{ $data->institution }} <small>{{ $data->start_date }} to
                                                        {{ $data->end_date ?? '' }}</small></p>
                                                <button type="button"
                                                    class="btn btn-secondary btn-sm editEducationButton"
                                                ...
                                                <button type="button"
                                                    class="btn btn-danger btn-sm deleteEducationButton"
                                                    data-id="{{ $data->id }}">
                                                    Delete
                                                </button>
                                            </div>
                                    ...
                                    <button type="button" class="btn btn-warning btn-lg float-rigth"
                                        data-bs-toggle="modal" data-bs-target="#educationModal" style="float: right">
                                        Add Education
                                    </button>
                                    ...
                                    <button type="button" class="btn btn-warning btn-lg float-rigth"
                                        data-bs-toggle="modal" data-bs-target="#projectModal" style="float: right">
                                        Add Project
                                    </button>
                                    ...
                                    <form action="#" method="post">
                                        ...
                                        <button type="submit" class="btn btn-warning mt-15 float-rigth btn-lg"
                                            style="float: right">
                                            Save Skills
                                        </button>
                                    </form>
                                ...
                                <div class="col-xl-12 col-12">
                                    <div class="card-grid-2 hover-up">
                                                ...
                                                <div class="card-grid-2-image-left">
                                                    <div class="image-box">
                                                        <img style="width: 50px"
                                                            src="{{ asset('profile/'.$data->job->employer->user->image) }}"
                                                            alt="jobBox">
                                                    </div>
                                                    <div class="right-info">
                                                        ...
                                                        <span
                                                            class="location-small">{{ $data->job->location->name }}</span>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="card-block-info">
                                            <h4><a
                                                    href="{{ route('frontend.jobs-detail', $data->job->id) }}">{{ $data->job->title }}</a>
                                            </h4>
                                            <div class="mt-5">
                                                <span class="card-briefcase">{{ $data->job->job_type }}</span>
                                                <span
                                                    class="card-time"><span>{{ $data->job->created_at->diffForHumans() }}</span></span>
                                            </div>
