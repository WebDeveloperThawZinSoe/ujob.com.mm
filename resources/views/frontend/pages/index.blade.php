...
<style>
  .banner-hero.hero-3::before {
    ...
    width: 100%;
    height: 100%;
    background-color: rgb(177, 123, 0,0.5);
    opacity: 0.8;
    z-index: 1;
}
.slider-controls {
...
<section class="section-box">
    <div id="banner-hero" class="banner-hero hero-2 hero-3 "
        style="background-image: url('./assets/imgs/page/homepage2/banner.png');background-color: rgba(0, 0, 0, 0.2);">
        <div class="banner-inner">
            <div class="block-banner">
                ...
                <div class="font-lg font-regular color-white mt-20 wow animate__animated animate__fadeInUp"
                    data-wow-delay=".1s">With our extensive network of top employers and a wide range of job
                    opportunities across various industries, to help you land your dream job.</div>
                <div class="form-find mt-40 wow animate__animated animate__fadeIn" data-wow-delay=".2s">
                    <form method="get" action="{{route('frontend.jobs')}}">
                        <input name="title" class="form-input input-keysearch mr-10" type="text"
                        ...
                        <div class="box-industry">
                            <select class="form-input mr-10 select-active input-industry" name="category_id">
                                ...
                                <option value="{{$data->id}}"
                                    {{ request('category_id') == $data->id ? 'selected' : '' }}>{{$data->name}}</option>
                                @endforeach
                            </select>
                        </div>
                ...
                <div class="swiper-container swiper-group-4 swiper">
                    <div class="swiper-wrapper pb-25 pt-5">
                        ...
                        <div class="swiper-slide hover-up"><a
                                href="{{route('frontend.jobs')}}/?category_id={{$data->id}}">
                                <div class="item-logo">
                                    <div class="text-info-right" style="width: 100%;">
                                        <h4 style="text-align: center;">{{$data->name}}</h4>
                                        <p class="font-xs" style="text-align: center;">{{$data->jobs->count()}}<span>
                                                Jobs Available</span></p>
                                    </div>
                                </div>
                            </a>
                        </div>
        ...
        <div class="slider-controls">
                        <button onclick="changeBackground(-1)" class="slider-btn">‹</button>
                        <button onclick="changeBackground(1)" class="slider-btn">›</button>
                    </div>
    </div>
</section>
...
<section class="section-box mt-70">
    <div class="container">
        <div class="text-center">
            ...
            <p class="font-lg color-text-paragraph-2 wow animate__animated animate__fadeInUp">Find Your Next Career
                Move: Featured Job Listings Just for You</p>
        ...
        <div class="mt-50">
                ...
                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
                    <div class="card-grid-2 grid-bd-16 hover-up">
                        <div class="card-block-info pt-25">
                            ...
                            <div class="mt-5"><span class="card-briefcase mr-15">{{$data->job_type}}</span><span
                            ...
                            <div class="card-2-bottom mt-20">
                                <div class="row">
                                    <div class="col-lg-7 col-md-7" style="min-height:40px !important">
                                        ...
                                        <div class="d-flex">
                                            <div class="info-right-img">
                                                <h6 class="color-brand-1 lh-14">{{$data->employer->company_name}}</h6>
                                                <span
                                                    class="card-location font-xxs pl-15 color-text-paragraph-2">{{$data->location->name }}</span>
                                            </div>
                                        </div>
                                        @else
                                        <div class="d-flex">
                                    ...
                                    <div class="col-lg-5 col-md-5 text-end"><span
                                            class="card-text-price">{{ number_format($data->salary) }}</span>
                                        &nbsp;<span class="text-muted">Month</span></div>
                                    @else
                                    <div class="col-lg-5 col-md-5 text-end"><span
                                            class="card-text-price">Negotiate</span></div>
            ...
            <div class="row mt-40 mb-60">
                <div class="col-lg-12">
                    <div class="text-center"><a class="btn btn-brand-1  mt--30 hover-up" href="/jobs">View More Jobs</a>
                    </div>
                </div>
            </div>
...
<section class="section-box mt-50 mb-30 bg-border-3 pt-100 pb-100">
    <div class="container">
        <div class="row">
            <div class="col-lg-6"><img class="bdrd-10" src="assets/imgs/page/homepage5/img-profile.png" alt="jobBox">
            </div>
            <div class="col-lg-6">
                <div class="pl-30">
                    ...
                    <p class="font-lg color-text-paragraph-2">Work Profile is a personality assessment that measures an
                        individual's work personality through their workplace traits, social and emotional traits; as
                        well as the values and aspirations that drive them forward.</p>
    ...
    <div class="section-box wow animate__animated animate__fadeIn mt-70">
        <div class="container">
            <div class="text-center">
                ...
                <p class="font-lg color-text-paragraph-2 wow animate__animated animate__fadeInUp">Find your favourite
                    jobs and get the benefits of yourself</p>
            </div>
            <div class="box-swiper mt-50">
                        ...
                        <div class="swiper-slide hover-up"><a href="{{route('frontend.jobs')}}/?category_id=3">
                                <div class="item-logo">
                                    <div class="image-left"><img alt="jobBox"
                                            src="{{asset('assets/imgs/codicon_location.svg')}}"></div>
                                    <div class="text-info-right">
                                        <h4>Nay Pyi Taw</h4>
                                        <p class="font-xs">
                                            {{ $locations->where('id', 3)->first()->jobs->count() }}<span>
                                                Vacancy</span></p>
                                    </div>
                                </div>
                            </a>
                        ...
                        <div class="swiper-slide hover-up"><a href="{{route('frontend.jobs')}}/?category_id=4">
                                <div class="item-logo">
                                    ...
                                    <div class="text-info-right">
                                        <h4>Yangon</h4>
                                        <p class="font-xs">
                                            {{ $locations->where('id', 1)->first()->jobs->count() }}<span>
                                                Vacancy</span></p>
                                    </div>
                                </div>
                            </a>
                        ...
                        <div class="swiper-slide hover-up"><a href="{{route('frontend.jobs')}}/?category_id=5">
                                <div class="item-logo">
                                    ...
                                    <div class="text-info-right">
                                        <h4>Bago</h4>
                                        <p class="font-xs">
                                            {{ $locations->where('id', 5)->first()->jobs->count() }}<span>
                                                Vacancy</span></p>
                                    </div>
                                </div>
                            </a>
                            ...
                            <a href="{{route('frontend.jobs')}}/?category_id=6">
                                <div class="item-logo">
                                    ...
                                    <div class="text-info-right">
                                        <h4>Chin</h4>
                                        <p class="font-xs">
                                            {{ $locations->where('id', 6)->first()->jobs->count() }}<span>
                                                Vacancy</span></p>
                                    </div>
                                </div>
                            </a>
                            ...
                            <a href="{{route('frontend.jobs')}}/?category_id=1">
                                <div class="item-logo">
                                    ...
                                    <div class="text-info-right">
                                        <h4>Ayeyawady</h4>
                                        <p class="font-xs">
                                            {{ $locations->where('id', 4)->first()->jobs->count() }}<span>
                                                Vacancy</span></p>
                                    </div>
                                </div>
                            </a>
                            ...
                            <a href="{{route('frontend.jobs')}}/?category_id=2">
                                <div class="item-logo">
                                    ...
                                    <div class="text-info-right">
                                        <h4>Mandalay</h4>
                                        <p class="font-xs">
                                            {{ $locations->where('id', 2)->first()->jobs->count() }}<span>
                                                Vacancy</span></p>
                                    </div>
                                </div>
                            </a>
        ...
        <div class="row">
            ...
            <div class="col-xl-5 col-lg-6 col-md-12 col-sm-12">
                ...
                <div class="box-checkbox mb-30">
                    ...
                    <p class="font-md color-text-paragraph-2">Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                        Donec nec justo a quam varius maximus. Maecenas sodales tortor quis tincidunt commodo.</p>
                </div>
                <div class="box-checkbox mb-30">
    ...
    <div class="container">
        <div class="mt-50">
                            ...
                            <div class="card-grid-3 hover-up wow animate__animated animate__fadeIn">
                                <div class="text-center card-grid-3-image">
                                    <a href="{{route('frontend.blog-detail', $item->id)}}">
                                        <figure><img alt="jobBox" src="{{ asset('articles'). '/' . $item->asset }}">
                                        </figure>
                                    </a>
                                </div>
                                <div class="card-block-info">
                                    <div class="tags mb-15"><a class="btn btn-tag"
                                            href="{{route('frontend.blog-detail', $item->id)}}">Blog</a></div>
                                    <h5><a href="{{route('frontend.blog-detail', $item->id)}}">{{ $item->title }}</a>
                                    </h5>
                                    {{-- <p class="mt-10 color-text-paragraph font-sm">{{ Str::limit($item->description, 20) }}
                                    </p> --}}
                                    <div class="card-2-bottom mt-20">
                                        <div class="row">
                                            <div class="col-lg-6 col-6">
                                                <div class="d-flex">
                                                    <div class="info-right-img"><span
                                                            class="font-xs color-text-paragraph-2">{{ \Carbon\Carbon::parse($item->date)->format('Y-m-d') }}</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
            ...
            <div class="text-center"><a class="btn btn-brand-1 btn-icon-load mt--30 hover-up"
                    href="{{route('frontend.blog')}}">Load More Posts</a></div>
        </div>
    </div>
</section>
                    ...
                    <div class="box-swiper">
                        <div class="swiper-container swiper-group-7 swiper">
                            <div class="swiper-wrapper">
                                @php
                                $images = App\Models\Images::where('type', 'partner')->get();

                                @endphp
                                @foreach($images as $img)
                                <div class="swiper-slide"><a href="{{$img->url}}"><img
                                            style="min-height:70px !important" src="{{ asset('ads/' . $img->image) }}"
                                            alt="{{ asset('ads/' . $img->title) }}"></a></div>
                                @endforeach
...
<script>
const backgrounds = [
    @foreach(App\Models\Images::where('type', 'banner') -> get() as $banner)
    "{{ asset('ads/' . $banner->image) }}",
    @endforeach
];
...
function showBackground(index) {
    const bannerElement = document.getElementById('banner-hero');
    if (bannerElement && backgrounds.length) {
        bannerElement.style.backgroundImage = `url('${backgrounds[index]}')`;
    }
}
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    intervalId = setInterval(() => changeBackground(1), 5000);
});
</script>
