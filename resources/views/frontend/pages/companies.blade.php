            ...
            <div class="col-12">
                <div class="content-page">
                    <div class="box-filters-job">
                        <div class="row">
                            <div class="col-xl-6 col-lg-5"><span class="text-small text-showing">Total
                            ...
                            <div class="col-xl-6 col-lg-7 text-lg-end mt-sm-15">
                                <!-- <div class="display-flex2">
                                    ...
                                    <div class="box-view-type"><a class="view-type" href="#"><img
                        ...
                        <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                            <div class="card-grid-1 hover-up wow animate__animated animate__fadeIn">
                                <div class="image-box"><a
                                        href="{{route('frontend.employer.profile', $data->company_name)}}"><img
                                            src="{{asset('profile/'.$data->user->image)}}" alt="jobBox"
                                            style="width: 70px"></a></div>
                                <div class="info-text mt-10">
                                    <h5 class="font-bold"><a
                                            href="{{route('frontend.employer.profile', $data->company_name)}}">{{$data->company_name}}</a>
                                    </h5>

                                    <span class="card-location">{{$data->location->name ?? ''}}</span>
                                    <div class="mt-30"><a class="btn btn-grey-big"
                                            href="{{route('frontend.employer.profile', $data->company_name)}}"><span>{{$data->activeJobs->count()}}</span><span>
