                        ...
                        <div class="card-grid-2 hover-up">
                          ...
                          <div class="card-block-info">
                            ...
                            <div class="card-2-bottom mt-20">
                              <div class="row">
                                @if($data->salary)
                                <div class="col-lg-7 col-7"><span class="card-text-price">{{number_format($data->salary)}}</span> Ks / Month</div>
                                @else
                                <div class="col-lg-7 col-7"><span class="card-text-price">Negotiate</div>
                                @endif
